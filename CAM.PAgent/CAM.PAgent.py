...
print('Machine Name: {0}'.format(''.join(socket.gethostname())))
...
for app in apps:
	...
	print('Machine Name: {0}|Software Name: {1}|InstallDate: {2} '.format(socket.gethostname(),app.InstalledProductName,app.InstallDate))
